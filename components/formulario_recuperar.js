...
export default function Formulario_Recuperar({titulo, funcaoSubmit, funcaoHandle, mensagemErro={email:''}, formValid = true, textoDireciona1, textoDireciona2, linkDireciona}){
