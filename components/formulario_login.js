...
export default function Formulario_Login({titulo, funcaoSubmit, funcaoHandle, mensagemErro={email:'', password:'', login: ''}, formValid = true, textoDireciona1, textoDireciona2, linkDireciona}){
    ...
    return(
        ...
        <form onSubmit={funcaoSubmit} className="max-w-sm mx-auto">
            ...
            <br/>
            <h1>Esqueceu a senha?<Link href='/recuperar_senha' className="text-green hover:text-green-800 focus:outline-none font-medium rounded-lg text-base w-full sm:w-auto text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"> Clique aqui</Link></h1>
        </form>
        </div>
    )
}